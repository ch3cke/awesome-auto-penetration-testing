...
<details><summary>Abstract</summary>
NYU CTF Bench is an open benchmark dataset for evaluating LLMs on offensive-security CTF tasks. It collects challenges with metadata for automated testing and adaptive learning, and pairs the dataset with an automation framework that supports tool-calling workflows for model evaluation.
</details>
